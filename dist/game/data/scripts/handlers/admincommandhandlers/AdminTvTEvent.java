...
public class AdminTvTEvent implements IAdminCommandHandler
{
	private static final String[] ADMIN_COMMANDS =
	{
		...
		"admin_tvt_remove",
		"admin_tvt_advance",
		"admin_tvt_set_team1_location",
		"admin_tvt_set_team2_location",
	};
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.equals("admin_tvt_advance"))
		{
			...
			activeChar.sendMessage("TvT event Team 1 location set: x:" + coords[0] + " y:" + coords[1] + " z:" + coords[2]);
		}
			...
			activeChar.sendMessage("TvT event Team 2 location set: x:" + coords[0] + " y:" + coords[1] + " z:" + coords[2]);
		}
